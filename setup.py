...
setup(
    ...
    packages=['thingsboard_gateway', 'thingsboard_gateway.gateway', 'thingsboard_gateway.gateway.proto', 'thingsboard_gateway.gateway.grpc_service',
              ...
              'thingsboard_gateway.connectors.modbus', 'thingsboard_gateway.connectors.can', 'thingsboard_gateway.connectors.bacnet_old',
              'thingsboard_gateway.connectors.bacnet_old.bacnet_utilities', 'thingsboard_gateway.connectors.odbc', 'thingsboard_gateway.connectors.bacnet',
              ...
              'thingsboard_gateway.extensions.can', 'thingsboard_gateway.extensions.bacnet_old', 'thingsboard_gateway.extensions.bacnet', 'thingsboard_gateway.extensions.odbc',
